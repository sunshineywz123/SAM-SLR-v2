...
class EGOXMLDataset(CocoDataset):
    def __init__(self, class_names, **kwargs):
        self.class_names = class_names
        super(EGOXMLDataset, self).__init__(**kwargs)
        ...
        for idx, xml_name in enumerate(ann_file_names):
            ...
            for _object in root.findall("object"):
                ...
                if category !='hand':
                    ...
                    continue
                handside=_object.find('handside').text
                if handside=='0':
                    category='lefthand'
                elif handside=='1':
                    category='righthand'
                    ...
                    logging.warning(
                        "WARNING! {} is not in handsides! "
                        "Pass this box annotation.".format(handside)
                    )
                    continue
